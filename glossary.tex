...
\newglossaryentry{trinh-viet-tro-choi}
{
    name={trình-viết-trò-chơi},
    description={(game engine)}
}

\newglossaryentry{xuyen-nen-tang}
{
    name={xuyên nền tảng},
    description={(cross-platform)}
}

\newglossaryentry{cau-phan-giao-dien}
{
    name={cấu phần giao diện},
    description={(UI component)}
}

\newglossaryentry{cau-phan-vat-li}
{
    name={cấu phần vật lí},
    description={(Physics component)}
}

\newglossaryentry{cai-dat}
{
    name={cài đặt},
    description={(setting)}
}

\newglossaryentry{the-hien}
{
    name={thể hiện},
    description={(instance)}
}

\newglossaryentry{moc-su-kien}
{
    name={mốc sự kiện},
    description={(hook)}
}
